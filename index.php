...
<body>
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-4">
                <marquee behavior="up" direction="scroll"><h2><u>Selamat Datang. Hello Guys</u></h2></marquee>
                <form method="post" class="border rounded p-2 mt-2" id="form">
                    <h5 class="text-center"><i>Aplikasi Perhitungan Diskon</i></h5>
                    <label class="form-label">Harga ( Rp. )</label>
                    <input type="number" class="form-control" name="harga" autocomplete="off" step="1" placeholder="Masukan Harga Barang.">
                    <label class="form-label">Diskon ( % )</label>
                    <input type="number" class="form-control" name="diskon" autocomplete="off" step="0.1" placeholder="Masukan Harga diskon.">
                ...
                if(isset($_POST['hitung'])){
                    ...
                    if($harga < 0){
                        ...
                        <div class="border rounded bg-light p-2 mt-3" name="huspa">
